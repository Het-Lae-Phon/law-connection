...
const HEADING_RE =
  /^(บรรพ\s*[๐-๙0-9]+|หมวด\s*[๐-๙0-9]+|ภาค\s*[๐-๙0-9]+|ลักษณะ\s*[๐-๙0-9]+|ส่วนที่\s*[๐-๙0-9]+|บทเฉพาะกาล$|บทนิยาม$|อัตราค่าธรรมเนียม$|บัญชี(ท้าย|อัตรา))/;
const SIGN_START_RE =
...
const FORCE_SPLIT_RE =
  /^(หมายเหตุ|ผู้รับสนองพระ(บรม)?ราชโองการ|ประกาศ\s*ณ\s*วันที่|สั่ง\s*ณ\s*วันที่|บรรพ\s*[๐-๙0-9]|หมวด\s*[๐-๙0-9]|ภาค\s*[๐-๙0-9]|ลักษณะ\s*[๐-๙0-9]|บทเฉพาะกาล$)/;
